const utils: Util[] = [
  ...
  },
  {
    ...
    seoDescription:
      "View and download any Minecraft player's capes, whether Mojang/Minecon or Optifine, by searching their in-game name.",
  },
  {
    path: "color-codes",
    name: "Color Codes",
  ...
  {
    path: "center-text-converter",
    name: "Center Text Converter",
    description: "Center text for use in books, signs and chat.",
